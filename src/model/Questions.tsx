...
export default function getThreeQuestions(level: number){
    switch (true) {
    case level < 4: return getListRandomItems(3, questions.veryEasy);
    case  level < 7: return  getListRandomItems(3, questions.easy);
    case  level < 10: return getListRandomItems(3, questions.normal);
    case level < 13: return getListRandomItems(3, questions.hard);
        default :return getListRandomItems(3, questions.veryHard)
    }
}
